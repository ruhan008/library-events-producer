...
public class LibraryEventProducer {
	...
	public SendResult<Integer, String> sendLibraryEventSynchronous(LibraryEvent libraryEvent)
		...
		try {
			...
			log.error("InterruptedException/ExecutionException sending the message and exception is {}",
					e.getMessage());
			throw e;
		} catch (Exception e) {
	...
	public ListenableFuture<SendResult<Integer, String>> sendLibraryEventApproach2(LibraryEvent libraryEvent)
	...
	private ProducerRecord<Integer, String> buildProducerRecord(Integer key, String value, String topic2) {
		List<Header> recordHeaders = List.of(new RecordHeader("event-source", "scanner".getBytes()),
				new RecordHeader("event-handler", "ruhan".getBytes()));
